...
public class FuncionarioRestController implements FuncionarioAPI {
    ...
    @Override
    public FuncionarioSingleResponse recuperarFuncionarioUnico(UUID idFuncionario) {
        log.info("[inicio] FuncionarioRestController - recuperarFuncionarioUnico");
        FuncionarioSingleResponse funcionarioSingleResponse
                = funcionarioApplicationService.retornarFuncionario(idFuncionario);
    ...
    public void deletarFuncionario(UUID idFuncionario) {
        log.info("[inicio] FuncionarioRestController - deletarFuncionario");
        funcionarioApplicationService.deletarFuncionario(idFuncionario);
        log.info("[finaliza] FuncionarioRestController - deletarFuncionario");
    }
